...
(function() {
  var $, $model_menu, $table_container, Row, api_prefix, csrf_token, date_re, input_type_map, loading_img, numeric_RE, save_latency, show_table, type_validators,
  ...
  Row = (function() {
    ...
    Row.prototype.startSaving = function() {
      ...
      $td_id = this.$row.find('td:first').html(loading_img);
      self = this;
      post_data = $.extend({
      ...
      return $.post(api_prefix + this.model + '/', post_data, function(result, status) {
        ...
        if (result.success) {
          ...
          return self.last_data = $.extend({}, self.row_data);
        } else {
