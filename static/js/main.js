...
(function() {
  var $, $model_menu, $table_container, Row, csrf_token, date_re, input_type_map, numeric_RE, show_table, type_validators,
  ...
  Row = (function() {
    ...
    function Row(model, row_data, id, $table) {
      var f, _i, _len, _ref;
      this.model = model;
    ...
    Row.prototype.startSaving = function() {
      ...
      return $.post('/api/' + this.model + '/', post_data, function(result, status) {
  ...
  show_table = function(model) {
    ...
    $.get('/api/' + model, function(data, status) {
